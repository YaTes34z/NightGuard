...
class Ennemi:
    def __init__(self, x, y, size=64):
        ...
        self.images = [pygame.transform.scale(img, (self.size * int(2*scale_multiplier), self.size * int(2*scale_multiplier))) for img in self.images]
        self.current_image_index = 0
        self.image = self.images[self.current_image_index]
        self.animation_timer = 0
        self.attack_cooldown = 0
...
def win():
    ...
    while True:
        ...
        if ancien is None or etoiles_obtenues1 > ancien:  # Vérifie si le score est meilleur
            ecrire_variable("sauvegarde1.txt", "etoiles_obtenues1", etoiles_obtenues1)
        draw_stars_win()
...
def main():
    ...
    while running:
        ...
        for moisissure in moisissures:
            FENETRE.blit(moisissure_image2, (moisissure[0] - camera_x, moisissure[1] - camera_y))
